 ...
 * EIR_Version
 *
 * Versioning utility for ExtendedInformationRedux
 *
 * Responsibilities:
 ...
 */
static function bool IsEirAtLeast(int Major, int Minor, int Patch)
{
 ...
 */
static function bool IsEirVersion(int Major, int Minor, int Patch)
{
 ...
 *
 * Example: "Extended Information (EIR) version: 0.1.0"
 *
 * @return string Display string
 */
static function string GetDisplayString()
{
    return "Extended Information Redux (EIR) version:" @ GetVersionString();
}
