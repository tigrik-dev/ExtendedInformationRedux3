...
{	
	return `MCM_CH_GetValue(class'MCM_Defaults'.default.FLYOVER_DURATION, class'ExtendedInformationRedux3_MCMScreen'.default.FLYOVER_DURATION);
}*/
...
simulated state Executing
{
	...
	function string GetChanceString()
	{
		...
		if(getTH_AIM_ASSIST()) chanceToPrint += class'ExtendedInformationRedux3_UITacticalHUD_ShotWings'.static.GetModifiedHitChance(AbilityState, chanceToPrint, , CurrentHistoryIndex - 1);
